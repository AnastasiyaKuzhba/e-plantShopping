...
function ProductList() {
    ...
    useEffect(() => {
        // Calculate total quantity when cartItems change
    ...
    return (
        <div>
            ...
            <div style={styleObjUl}>
                ...
                <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}><div className="cart-container"> {/* Added container */}
      <h1 className="cart">
        <svg
      ...
      <span className="cart_quantity_count">{cartQuantity}</span> {/* Added text */}
    </div></a></div>
            </div>
        </div>
        {!showCart? (
